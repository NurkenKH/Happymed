...
def answer_query_route():
    ...
    return jsonify(response), status_code
@routes.route('/feedback/<int:appointment_id>', methods=['GET'])
def feedback_get(appointment_id):
    return get_feedback(appointment_id)

@routes.route('/feedback/<int:appointment_id>', methods=['PUT'])
def feedback_edit(appointment_id):
    data = request.get_json()
    return edit_feedback(appointment_id, data)

@routes.route('/cancel_appointment_by_doctor', methods=['POST'])
def cancel_appointment_by_doctor_route():
    data = request.get_json()
    response, status_code = cancel_appointment_by_doctor(data)
    return jsonify(response), status_code

@routes.route('/cause/<int:appointment_id>', methods=['GET'])
def cause_get(appointment_id):
    return get_cause(appointment_id)